...
def charging_policy(data_dir, file_name):
    '''
    Args: 
        data_dir: data files dir
        file_name: csv file name
    Returns: 
        None
    Detail: 
        Generates all policies within a 4-step policy 
        space based on your specifications.
    '''    
    ...
    ## Save policies
    np.savetxt(os.path.join(data_dir, 'policies_' + file_name + '.csv'), valid_policies, delimiter=',', fmt='%1.3f')

    surface_points.plot_surface(C1, C2, C3, C4_LIMITS, data_dir, file_name)
